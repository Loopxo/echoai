...
class MinimalCLIService {
    ...
    panel;
    logs = [];
    maxLogs = 50; // Much smaller log buffer
    isProcessing = false;
    ...
    showCLI() {
        ...
        this.panel = vscode.window.createWebviewPanel('echo-ai-minimal-cli', 'Echo AI', vscode.ViewColumn.Beside, {
            enableScripts: true,
    ...
    async handleAICommand(command) {
        ...
        try {
            const response = await this.echoProvider.getCompletion(command, context, editor?.document.languageId || 'plaintext', 1000 // Shorter responses for CLI
            );
...
exports.MinimalCLIService = MinimalCLIService;
//# sourceMappingURL=MinimalCLIService.js.map