...
exports.CodeContextExtractor = void 0;
class CodeContextExtractor {
    extractRelevantContext(document, position, maxTokens = 500) {
    ...
    findCurrentFunction(lines, currentLine) {
    ...
    findCurrentClass(lines, currentLine) {
    ...
    extractImports(lines, languageId) {
        const imports = [];
    ...
    extractVariables(lines, currentLine, languageId) {
        const variables = [];
    ...
    extractNearbyCode(lines, currentLine, windowSize) {
    ...
    extractMethodSignatures(document) {
        const text = document.getText();
        const signatures = [];
