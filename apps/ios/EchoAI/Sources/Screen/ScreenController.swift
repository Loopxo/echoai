...
final class ScreenController {
    ...
    /// Callback invoked when an echoai:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = EchoAIKitResources.bundle
...
/// Handles navigation policy to intercept echoai:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept echoai:// deep links.
        if url.scheme?.lowercased() == "echoai" {
