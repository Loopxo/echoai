...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: EchoAILocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: EchoAILocationGetParams,
        desiredAccuracy: EchoAILocationAccuracy,
        maxAgeMs: Int?,
    ...
    private static func accuracyValue(_ accuracy: EchoAILocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
