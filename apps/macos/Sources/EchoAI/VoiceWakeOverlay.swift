...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.echoai", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other EchoAI windows, but below the system’s pop-up menus.
