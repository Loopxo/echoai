...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.echoai", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return EchoAIConfigFile.defaultWorkspaceURL() }
