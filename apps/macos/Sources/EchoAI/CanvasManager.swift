...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.echoai", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("EchoAI/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__echoai__/a2ui/").absoluteString + "?platform=macos"
    }
