...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.echoai", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        EchoAIPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        EchoAIPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
