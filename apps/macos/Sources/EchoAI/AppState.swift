...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = EchoAIConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = EchoAIConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = EchoAIConfigFile.loadDict()
            ...
            EchoAIConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/echoai"
        state.remoteCliPath = ""
        return state
    }
}
