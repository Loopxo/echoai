...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.echoai", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.echoai", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [EchoAIChatMessage] = messages.compactMap { item in
