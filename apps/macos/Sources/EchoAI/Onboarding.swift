...
enum UIStrings {
    static let welcomeTitle = "Welcome to EchoAI"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: EchoAIOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: EchoAIChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g echoai@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: EchoAIChatViewModel(
