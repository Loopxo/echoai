...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/echoai/echoai") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/echoai/echoai")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://echoai.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "EchoAIBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "EchoAIBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "EchoAIGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "EchoAIGitCommit") as? String) ??
            "unknown"
    }
