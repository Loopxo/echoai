...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .echoaiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? EchoAIPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? EchoAIPaths.stateDirURL.path
...
extension Notification.Name {
    static let echoaiSelectSettingsTab = Notification.Name("echoaiSelectSettingsTab")
}
