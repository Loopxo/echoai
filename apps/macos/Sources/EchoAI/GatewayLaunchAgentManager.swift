...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.echoai", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".echoai/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.echoaiCommand(
            subcommand: "gateway",
