...
public enum EchoAICanvasA2UICommand: String, Codable, Sendable {
...
public struct EchoAICanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct EchoAICanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
