...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.echoai", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.echoai", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: EchoAIProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
