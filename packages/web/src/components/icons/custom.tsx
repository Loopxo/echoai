...
export function IconEchoAI(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M12 2L13.09 8.26L19.91 6.17L17.82 12.91L24 12L17.74 13.09L19.83 19.91L13.09 17.82L12 24L10.91 17.74L4.09 19.83L6.18 13.09L0 12L6.26 10.91L4.17 4.09L10.91 6.18L12 2Z"
        fill="currentColor"
      />
    </svg>
  )
